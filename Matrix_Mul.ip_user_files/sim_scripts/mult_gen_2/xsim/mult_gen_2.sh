...
#
# Script generated by Vivado on Fri Dec 29 14:39:51 +0800 2023
...
#
# Usage        : mult_gen_2.sh
#                mult_gen_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_gen_2.sh [-reset_run]
#                mult_gen_2.sh [-reset_log]
#                mult_gen_2.sh [-help]
#
...
# script info
echo -e "mult_gen_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_gen_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L xil_defaultlib -L secureip -L xpm --snapshot mult_gen_2 xil_defaultlib.mult_gen_2 -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_gen_2.wdb xsim.dir libdpi.so)
...
Usage: mult_gen_2.sh [-step]\n\
Usage: mult_gen_2.sh [-lib_map_path]\n\
Usage: mult_gen_2.sh [-reset_run]\n\
Usage: mult_gen_2.sh [-reset_log]\n\
Usage: mult_gen_2.sh [-keep_index]\n\
